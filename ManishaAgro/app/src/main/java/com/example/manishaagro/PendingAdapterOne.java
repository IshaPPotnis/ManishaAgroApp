...
public class PendingAdapterOne extends RecyclerView.Adapter<PendingAdapterOne.MyViewHolder> {
    private static List<TripModel> tripPenModelList;
    public Context context;
    private PendingAdapterOne.RecyclerViewClickListener mListener;


    public PendingAdapterOne(List<TripModel> penReport, Context context, RecyclerViewClickListener listener) {
