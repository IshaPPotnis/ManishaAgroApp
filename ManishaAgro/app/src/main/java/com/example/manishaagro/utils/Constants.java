...
public class Constants {
    public static final String STATUS = "VISIT";
    ...
    public static final String STATUS_VISITED_CUSTOMER_NAME = "StatusCustName";
    public static final String STATUS_DATE_OF_TRAVEL = "StatusDtTravel";
